...
const metaInfo = await (async () => {
    for (const release of releases) {
        const metaAsset = release.assets.find((a: any) => a.name === "online.xocat.santi.discord.metainfo.xml");
...
await fs.writeFile("./dist/online.xocat.santi.discord.metainfo.xml", output, "utf-8");
console.log("Updated meta information written to ./dist/online.xocat.santi.discord.metainfo.xml");