...
export const Settings = loadSettings<TSettings>(SETTINGS_FILE, "santi.discord settings");
export const VencordSettings = loadSettings<any>(VENCORD_SETTINGS_FILE, "Vencord settings");
export const State = loadSettings<TState>(STATE_FILE, "santi.discord state");
